...
"This is paramount! What is? I can't remember.", "Warehouse Tip Friday", "What if this script becomes self aware?", "This is my warehouse!", "Come to the dark side, we have cookies.",
...
"Make it so number one.", "Goldberry is waiting.", "My precious!"]
